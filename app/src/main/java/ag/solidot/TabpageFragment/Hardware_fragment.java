...
public class Hardware_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_hardware = (RecyclerView) view.findViewById(R.id.rv_hardware);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_hardware);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_hardware.setLayoutManager(mLayoutManager);
        ...
        rv_hardware.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_hardware.setItemAnimator(new DefaultItemAnimator());
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_hardware.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
