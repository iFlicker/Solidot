...
public class Cloud_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_cloud = (RecyclerView) view.findViewById(R.id.rv_cloud);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_cloud);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_cloud.setLayoutManager(mLayoutManager);
        ...
        rv_cloud.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_cloud.setItemAnimator(new DefaultItemAnimator());
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_cloud.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
