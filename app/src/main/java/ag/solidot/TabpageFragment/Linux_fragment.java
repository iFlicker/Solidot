...
public class Linux_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_linux = (RecyclerView) view.findViewById(R.id.rv_linux);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_linux);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_linux.setLayoutManager(mLayoutManager);
        ...
        rv_linux.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_linux.setItemAnimator(new DefaultItemAnimator());
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_linux.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
