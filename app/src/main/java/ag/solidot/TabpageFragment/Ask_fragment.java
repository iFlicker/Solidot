...
public class Ask_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_ask = (RecyclerView) view.findViewById(R.id.rv_ask);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_ask);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_ask.setLayoutManager(mLayoutManager);
        ...
        rv_ask.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_ask.setItemAnimator(new DefaultItemAnimator());
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_ask.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
