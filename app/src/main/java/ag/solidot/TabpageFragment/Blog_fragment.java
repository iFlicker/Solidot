...
public class Blog_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_blog = (RecyclerView) view.findViewById(R.id.rv_blog);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_blog);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_blog.setLayoutManager(mLayoutManager);
        ...
        rv_blog.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_blog.setItemAnimator(new DefaultItemAnimator());
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_blog.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
