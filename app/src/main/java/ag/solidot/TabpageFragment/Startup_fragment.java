...
public class Startup_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_startup = (RecyclerView) view.findViewById(R.id.rv_startup);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_startup);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_startup.setLayoutManager(mLayoutManager);
        ...
        rv_startup.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_startup.setItemAnimator(new DefaultItemAnimator());
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_startup.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
