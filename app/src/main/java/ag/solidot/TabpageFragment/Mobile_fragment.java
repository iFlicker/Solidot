...
public class Mobile_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_mobile = (RecyclerView) view.findViewById(R.id.rv_mobile);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_mobile);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_mobile.setLayoutManager(mLayoutManager);
        ...
        rv_mobile.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_mobile.setItemAnimator(new DefaultItemAnimator());
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_mobile.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
