...
public class Idle_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_idle = (RecyclerView) view.findViewById(R.id.rv_idle);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_idle);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_idle.setLayoutManager(mLayoutManager);
        ...
        rv_idle.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_idle.setItemAnimator(new DefaultItemAnimator());
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_idle.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
