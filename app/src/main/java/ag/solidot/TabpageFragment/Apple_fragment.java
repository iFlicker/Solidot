...
public class Apple_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_apple = (RecyclerView) view.findViewById(R.id.rv_apple);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_apple);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_apple.setLayoutManager(mLayoutManager);
        ...
        rv_apple.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_apple.setItemAnimator(new DefaultItemAnimator());
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_apple.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
