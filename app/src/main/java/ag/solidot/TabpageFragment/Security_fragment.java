...
public class Security_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_security = (RecyclerView) view.findViewById(R.id.rv_security);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_security);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_security.setLayoutManager(mLayoutManager);
        ...
        rv_security.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_security.setItemAnimator(new DefaultItemAnimator());
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_security.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
