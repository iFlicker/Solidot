...
public class Technology_fragment extends Fragment {////////////////////////////////////////////////////////////
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        classL.clear();
        final RecyclerView rv_technology = (RecyclerView) view.findViewById(R.id.rv_technology);
        final SwipeRefreshLayout srl = (SwipeRefreshLayout) view.findViewById(R.id.rvs_technology);


        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(OrientationHelper.VERTICAL); //设置垂直
        rv_technology.setLayoutManager(mLayoutManager);
        ...
        rv_technology.setAdapter(new ScaleInAnimationAdapter(alphaAdapter));
        rv_technology.setItemAnimator(new DefaultItemAnimator());
        ...
        SwipeRefreshLayout.OnRefreshListener srlListener = new SwipeRefreshLayout.OnRefreshListener(){
            ...
            public void onRefresh() {
                OkHttpUtils
                        .get()
                        .url("http://technology.solidot.org/")////////////////////////////////////////////////////////////
                        .build()
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                mra.removeAll();
                                mra.addAll(classL);
                                rv_technology.smoothScrollToPosition(0);
                                srl.setRefreshing(false);
                            }
                        });
            }
